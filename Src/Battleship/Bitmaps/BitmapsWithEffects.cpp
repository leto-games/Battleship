...
// {
//     BM_Popal_Sticker = *BitmapData::FromHandle(leto_api_v1->Bitmap->ResizeCopyBitmap(BitmapData::ToHandle(&BM_PopalText), allocator, 52, 20));
//     BM_Ubil_Sticker = *BitmapData::FromHandle(leto_api_v1->Bitmap->ResizeCopyBitmap(BitmapData::ToHandle(&BM_UbilText), allocator, 52, 20));
...
//     BM_Popal_Sticker_Rotating = *BitmapData::FromHandle(leto_api_v1->Bitmap->CopyBitmap(BitmapData::ToHandle(&BM_Popal_Sticker), allocator));
